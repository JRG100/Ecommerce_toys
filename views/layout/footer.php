            ...
            <div class="row">
                <div class="col-md-4 mb-4 mb-md-0 text-center">
                    ...
                    <nav class="d-flex flex-column">
                        <a class="text-dark text-decoration-none" href="#">Juegos</a>
                        <a class="text-dark text-decoration-none" href="#">Peluche</a>
                        <a class="text-dark text-decoration-none" href="#">Madera</a>                       
                    </nav>
                </div>

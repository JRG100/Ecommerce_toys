...
<body>
        ...
        <div class="navbar navbar-expand-lg container navbar-light ">
            ...
            <div id="navegacion" class="collapse navbar-collapse">
                <nav class="navbar-nav container d-flex flex-md-row justify-content-md-end text-center navegacion">
                    <a class="text-decoration-none navegacion__enlace" href="index.html">Inicio</a>
    ...
    <section class="container-xl">
        ...
        <div class="row mt-5">
            <div class="col-md-4 categoria">
                ...
                <a class="text-dark fs-2 text-decoration-none text-center d-block py-3" href="#">Mini-Mons</a>
            </div>
    ...
    <footer class="pt-5 mt-5 border-top">
        <div class="container-xl mt-5">
            ...
            <p class="mt-5 text-center fs-2">Todos los derechos Reservados. TiendaTOYS</p>
        </div>
    </footer>
